...
MODEL_PATH = "emg_mlp_model_clean_noisy.joblib"
SCALER_PATH = "emg_scaler_clean_noisy.pkl"            # optional
LABEL_ENCODER_PATH = "emg_label_encoder_clean_noisy.pkl"  # optional
